...
export default function MixtapeEditor({
  mixtape,
  onMixtapeClaimed,
  onMixtapeUpdated,
}: MixtapeEditorProps) {
  ...
  const handleSave = useCallback(
    async (values: FormValues, immediate: boolean = false) => {
        ...
        {({ values, setFieldValue, resetForm }) => (
          <>
            ...
            <MixtapeEditorToolbar
              ...
              resetForm={(updatedMixtape: MixtapeResponse) =>
                resetForm({ values: mixtapeToFormValues(updatedMixtape) })
              }
