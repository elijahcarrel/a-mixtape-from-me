 ...
 */
export const exportToSpotifyApiMixtapePublicIdSpotifyExportPost = <ThrowOnError extends boolean = false>(options: Options<ExportToSpotifyApiMixtapePublicIdSpotifyExportPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ExportToSpotifyApiMixtapePublicIdSpotifyExportPostResponses, ExportToSpotifyApiMixtapePublicIdSpotifyExportPostErrors, ThrowOnError>({
