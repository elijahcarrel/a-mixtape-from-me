import { MixtapeTrackRequest, MixtapeTrackResponse, TrackDetails } from "../client";

export const normalizeTrackToRequest = (t: MixtapeTrackResponse | MixtapeTrackRequest): MixtapeTrackRequest => ({
...
export const normalizeTrackToResponse = (t: MixtapeTrackResponse | MixtapeTrackRequest): MixtapeTrackResponse => ({
    track_position: t.track_position,
    track_text: t.track_text,
