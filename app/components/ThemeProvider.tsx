...
const ThemeContextForStackAuth = createContext<ThemeContextType | undefined>(undefined);

export function useThemeForStackAuth() {
  const context = useContext(ThemeContextForStackAuth);
...
export default function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ThemeContextForStackAuth.Provider value={{ theme, setTheme: handleSetTheme }}>
      {children}
    </ThemeContextForStackAuth.Provider>
  );
}
